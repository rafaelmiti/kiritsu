...
class AgendaModelTest extends TestCase{
	...
	protected function setUp(){
        $this->agenda = new \Model\Agenda(self::$config, true);
        $this->c = $this->agenda->c;
        
        $tupla = [$this->c[0] => '1', $this->c[1] => 'Categoria', $this->c[2] => 'Atividade', $this->c[3] => '2015-02-04', $this->c[4] => '13:13', $this->c[5] => '0', $this->c[6] => '0'];
	...
	public function testEditar(){
        $tupla = [$this->c[0] => '1', $this->c[1] => 'Categoria 2', $this->c[2] => 'Atividade 2', $this->c[3] => '2015-02-05', $this->c[4] => '13:14:00', $this->c[5] => '1', $this->c[6] => '1'];
