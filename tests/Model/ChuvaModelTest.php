...
class ChuvaModelTest extends TestCase
{
    ...
    {
        $this->chuva = new Chuva(self::$config, true);
		$this->chuva->criar(['id' => 1, 'data' => '2015-12-04', 'intensidade' => 1]);
	}
    ...
    {
        $tupla = ['id' => '1', 'data' => '2015-12-05', 'intensidade' => '2'];
    ...
    public function testPaginar()
    {
        ...
        $this->assertSame(732, $this->chuva->getTotal());
